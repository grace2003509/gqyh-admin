    ...
    <body>
        <div class="boxes">
            <div class="container">
                <div class="content">
                    <div>
                        <div class="title"> (눈_눈)  抱歉，您没有操作该功能的权限  (；′⌒`) </div>
                        <h4 class="split"><span>●</span></h4>
                        <div>
                            <a href="/">返回首页</a> / <a href="{{isset( $_SERVER["HTTP_REFERER"])? $_SERVER["HTTP_REFERER"]:'javascript:history.go(-1)'}}">返回上页</a>
                        </div>
                    </div>
                </div>
            </div>
