...
<script type='text/javascript' src='/static/js/plugins/dragsort/ca_drag.js'></script>
<script type='text/javascript' src='/static/js/plugins/dragsort/ca_orderDrag.js'></script>
...
<div class="box">
  <div id="iframe_page">
    <div class="iframe_content">
      ...
      <div class="r_con_config r_con_wrap" style="min-height: 720px">
        <!-- 组件栏start -->
  ...
  <script>
      ...
      KindEditor.ready(function(K) {
          editor = K.create('textarea[name="content"]', {
              themeType : 'simple',
              filterMode : true,
              uploadJson : '/admin/upload_json?TableField=web_home',
