        ...
        <div id="iframe_page">
            <div class="iframe_content">
                ...
                <div id="column" class="r_con_wrap">
                    <form id="column_form" class="r_con_form" method="post" action="{{route('admin.web.column_store')}}">
                        {{csrf_field()}}
                        <div class="rows">
                            <label>栏目排序</label>
                            <span class="input">
                                ...
                                <select name="ParentID" class="parent">
                                  <option value="0">一级栏目</option>
                                    @foreach($columns as $key => $r)
                                        <option value="{{$r["Column_ID"]}}" @if(old('ParentID') == $r['Column_ID']) selected @endif>{{$r["Column_Name"]}}</option>
                                    @endforeach
                                </select>
                            </span>
                            <div class="clear"></div>
                        ...
                        <div class="rows">
                            ...
                            <span class="input opt">
                              <input type="checkbox" value="1" name="Link" @if(old('Link') == 1) checked @endif />
                              <span id="LinkUrl_span">
                                  <input name="LinkUrl" value="{{old('LinkUrl')}}" type="url" class="form_input" size="40" id="web_common_url" >
                              </span>
                            </span>
                            <div class="clear"></div>
                        </div>
                        <div class="rows" id="Option_rows">
                            ...
                            <span class="input opt">
                                <span class="pop_sub_menu">弹出二级菜单:
                                    <input type="checkbox" value="1" name="PopSubMenu" @if(old('PopSubMenu') == 1) checked @endif  />
                                </span> 导航显示:
                                <input type="checkbox" value="1" name="NavDisplay" @if(old('NavDisplay') == 1) checked @endif />
                            </span>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="rows">
                            <label>页面显示</label>
                            <span class="input">
                                <input type="radio" name="PageType" value="0" id="PageType0" @if(old('PageType') == 0) checked @endif />
                                <label for="PageType0">内容列表</label>&nbsp;&nbsp;
                                <input type="radio" name="PageType" value="1" id="PageType1" @if(old('PageType') == 1) checked @endif />
                        ...
                        <div class="rows" id="ListType_rows" style="display:block">
                            ...
                            <span class="input">
                              <ul id="column-article-list-type">
                                <li>
                                      <input name="ListTypeID" type="radio" value="0"  @if(old('ListTypeID') == 0) checked @endif >
                                ...
                                <li>
                                      <input name="ListTypeID" type="radio" value="1"  @if(old('ListTypeID') == 1) checked @endif>
                                ...
                                <li>
                                      <input name="ListTypeID" type="radio" value="2"  @if(old('ListTypeID') == 2) checked @endif>
                                ...
                                <li>
                                      <input name="ListTypeID" type="radio" value="3"  @if(old('ListTypeID') == 3) checked @endif>
