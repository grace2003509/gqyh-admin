            ...
            <div class="iframe_content">
                ...
                <div id="user_profile" class="r_con_wrap">
                    ...
                    <div class="control_btn" style="margin-left: 0px">
                        <a href="{{route('admin.shop.on_off_index', ['type' => 2])}}" class="btn_green btn_w_120">个人中心</a>
                        <a href="{{route('admin.shop.on_off_index', ['type' => 1])}}" class="btn_green btn_w_120">分销中心</a>
                    </div>
                    ...
                    <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="r_con_table">
                        ...
                        @foreach($perm_config as $key=>$value)
                            <tr>
                                ...
                                <td>{{$value['Perm_index']}}</td>
                                <td>
                                    @if($value['Perm_On'] == 1)
                                        <a href="{{route('admin.shop.on_off_edit', ['id'=>$value['Permission_ID']])}}" style="text-decoration: none">
...
{{--                                            @if(empty($value['Perm_Field']))--}}
                    ...
                    <form class="r_con_form" action="{{route('admin.shop.on_off_store')}}" style="margin-top:10px" method="post">
                                ...
                                <table border="0" cellpadding="5" cellspacing="0" style="width: 100%;text-align: center;" class="reverve_field_table">
                                    ...
                                    <tbody class="form_list">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="index" value="0" class="sun_input" size="5" maxlength="10"  />
                                            </td>
                                            {{--<td>
                        ...
                        <div class="rows">
                            <label>&nbsp;</label>
                            <span class="input">
                                <input type="submit" class="btn_ok" style="margin-left: 40%;" name="submit_button" value="提交保存" />
                            </span>
                            <div class="clear"></div>
                        </div>
                    </form>
                            ...
                            <table border="0" cellpadding="5" cellspacing="0" style="width: 100%;text-align: center;" class="reverve_field_table">
                                ...
                                <tbody class="form_list">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="index" id="edit_index_default" value="" class="sun_input" size="5" maxlength="10"  />
                                        </td>
                                        {{--<td>
                                            <a href="javascript:void(0);" class="form_add">
                                                <img src="/admin/images/ico/add.gif" />
    ...
    <script>
        ...
        function Values(compay) {
            ...
            $('#edit_index_default').val(compay['Perm_index']);
