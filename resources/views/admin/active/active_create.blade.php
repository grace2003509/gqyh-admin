        ...
        <div id="iframe_page">
            <div class="iframe_content">
                ...
                <div id="products" class="r_con_wrap">
                    <form id="product_add_form" class="r_con_form skipForm" method="post" action="{{route('admin.active.store')}}">
                        {{csrf_field()}}
                        <div class="rows">
                            <label>活动名称</label>
                            <span class="input">
							    <input type="text" name="Active_Name" value="{{old('Active_Name')}}" class="form_input" size="5" style="width: 200px; float: left;" maxlength="10" />
                            ...
                            <span class="input">
                                <select name="ActiveType">
                                 ...
                                 @foreach ($typelist as $k => $v)
                                    <option value="{{$k}}" @if(old('ActiveType') == $k) selected @endif >{{$v}}</option>
                                 @endforeach
                        ...
                        <div class="rows">
                            ...
                            <span class="input" style="font-size: 12px;">
							    <input type="radio" id="status_0" value="0" @if(old('Status') == 0) checked @endif name="Status" />
