...
@section('css')
<link rel="stylesheet" href="/vendor/admin-lte/dist/css/skins/skin-red-light.min.css">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="{{ route('user.logout') }}" class="btn btn-default"><i class="fa fa-sign-out"></i> 退出</a>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="{{ route('user.logout') }}"><i class="fa fa-sign-out"></i> 退出</a>
                </li>
            </ul>
        </div>
    </nav>
