...
class PaymentBillController extends Controller
{
    public function index(Request $request)
    {
        ...
        foreach($lists as $key => $value){
            ...
            $lists[$value['Biz_ID']] = $value;
        }

        return view('admin.statistics.bill',
            compact('lists', 'STATUS', 'BizRs', 'BizPayRate'));
    }
    ...
    public function show($id)
    {
        ...
        $dtotalmoney = $sb_obj->rmb_format($totalmoney);
        ...
        foreach($data as $key => $value){
            ...
            $value['Order_Sn'] = $so_obj->getorderno($value["Order_ID"]);
        }
