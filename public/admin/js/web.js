var web_obj={
    ...
    home_init:function(){
        ...
        $('#web_skin_index .web_skin_index_list .mod').click(function(){
            ...
            $('#SetHomeCurrentBox').css({'height':parent.height(), 'width':parent.width()})
        ...
        $('#home_form input:submit').click(function(){
            ...
            $.post('/admin/web/home_config_update', $('#home_form').serialize()+'&do_action=set_home_mod&Dwidth='+Dwidth+'&DHeight='+DHeight, function(data){
    ...
    "btnCtrl"	: function(){
        ...
        $.ajax({
            type    : "POST",
            url     : "/admin/web/home_config_update",
            data    : "gruopPackage="+encodeURIComponent(str)+"&do_action=home_diy&date="+new Date(),
            dataType:"json",
