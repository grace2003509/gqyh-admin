...
var shop_obj = {
    ...
    home_init: function () {
        ...
        $('#shop_skin_index .shop_skin_index_list').hover(function () {
            $(this).find('.mod').show();
        }, function () {
            $(this).find('.mod').hide();
        });
        ...
        $('#shop_skin_index .shop_skin_index_list .mod').click(function () {
            ...
            $('#SetHomeCurrentBox').css({'height': parent.height() - 10, 'width': parent.width()});
...
/*        $('#home_form').submit(function () {
    ...
    withdraw_method_init: function () {
        ...
        $('#create_method_form input:submit').click(function () {
            if (global_obj.check_form($('#create_method_form *[notnull]'))) {
                return false
            }
            ;
        });
    ...
    products_category_init: function () {
        ...
        $('#shop_category_form').submit(function () {
            return false;
        });
    ...
    products_property_init: function () {
        ...
        $('#products_property_form').submit(function () {
            return false;
        });
    ...
    orders_init: function () {
        ...
        $("#search_form .output_btn").click(function () {
            window.location = './outputs.php?' + $('#search_form').serialize() + '&type=order_detail_list';
        });
        ...
        $('#orders_mod_form').submit(function () {
            $('#orders_mod_form input:submit').attr('disabled', true);
        });
        $('#orders_mod_form .cp_item_mod .back').click(function () {
            $('#orders .cp_title #cp_view').click();
        });
    ...
    distribute_init: function () {
        ...
        //提交驳回用户申请
        $('#reject_withdraw form').submit(function () {
            return false;
        });
        ...
        $('#mod_account_card form').submit(function () {
            return false;
        });
    ...
    //---------- diy页面 ----------//
    diy_init: function () {
        $('.btn_select_url').click(function () {
            var thisid = $(this).prev("select").attr('id');
            global_obj.create_layer('选择链接', '/member/shop/pagemakeup/UrlList.php?' + thisid, 1000, 200, 1);
        });
    ...
    "Evt3": "onmouseover='this.src=\"/admin/images/diy/select_1.png\"' onmouseout = 'this.src=\"/admin/images/diy/select.png\"'",
    "cloIco": "/admin/images/diy/del.png",
    "firstrproperty": "",
    "p1": { //一行两列
